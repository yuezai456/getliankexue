...
//        System.out.println(s);
        ...
        value.setPreviousExamTime(1);
        SubjectLevelList subjectLevelList=new SubjectLevelList();

        value.setSubjectLevelList(subjectLevelList);
        value.setPreviousExamName("考试");
        subjectLevelList.setIsMySubject("1");
